                ...
                <div class="col fill_height">
                    ...
                    <div class="search_tabs_container">
                        <div class="search_tabs d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
                            <div class="search_tab active d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><i class="nav-icon fa fa-car"></i><img src="{{url('theme/images/suitcase.png')}}" alt=""><span>Parking</span></div>
                    ...
                    <div class="search_panel active">
                        <form method="get" action="{{ route("searchresult") }}" id="search_form_1" class="search_panel_content d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
                               ...
                               <select required name="airport_id"   class="dropdown_item_select search_input" required="required"> <option   value="">Airport</option>
                    ...
                    <div class="search_panel">
                        ...
                        <center>    <button type="button" class="button search_button">Comming Soon<span></span><span></span><span></span></button> </center>
                        </form>
                    </div>

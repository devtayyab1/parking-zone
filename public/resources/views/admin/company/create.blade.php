            ...
            <div class="col-xs-12">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        ...
                        {{ Form::open(array('class'=>'form-horizontal','method'=>'post','route' => 'company.store', 'files' => true)) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                {{ Form::text('company_code',  Input::old('company_code'), array('class' => 'col-xs-10 col-sm-5')) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                {{ Form::text('aph_id',  Input::old('aph_id'), array('class' => 'col-xs-10 col-sm-5')) }} 
                            ...
                            <div class="col-sm-9" id="company_email_div">
                                ...
                                @if(Input::old('company_email')!="")
                                    ...
                                    @if($counter==1)
                                        ...
                                        {{ Form::text('company_email[]',  Input::old('company_email')[$counter-1], array('class' => 'col-xs-10 col-sm-5')) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                {{ Form::select('airport_id',$airportsList,null,["id"=>'airport_id' ,"class"=>"form-control","style"=>"width: 97.5%;"]) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                {{ Form::text('address',  Input::old('address'), array('class' => 'col-xs-10 col-sm-5')) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                {{ Form::text('address2',  Input::old('address2'), array('class' => 'col-xs-10 col-sm-5')) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                {{ Form::text('town',  Input::old('town'), array('class' => 'col-xs-10 col-sm-5')) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                {{ Form::text('post_code',  Input::old('post_code'), array('class' => 'col-xs-10 col-sm-5')) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                {{ Form::select('parking_type',["Park and Ride"=>"Park and Ride","Meet and Greet"=>"Meet and Greet","On Airport"=>"On Airport"],null,["class"=>"form-control","style"=>"width:97.5%"]) }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    {{ Form::text('message',  Input::old('message'), array('class' => 'col-xs-10 col-sm-5')) }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    {{ Form::select('process_time',$processTime,null,["class"=>"form-control","style"=>"width:97.5%"]) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                ...
                                {{ Form::select('opening_time',$opening_closing_time) }}
                            ...
                            <div class="col-sm-3">
                                ...
                                {{ Form::select('closing_time',$opening_closing_time) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                ...
                                {{ Form::textarea('return_proc', Input::old('return_proc'), array('id'=>'return','class' => 'col-xs-10 col-sm-5', "data-provide"=>"markdown")) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                ...
                                {{ Form::textarea('returnfront', Input::old('returnfront'), array('id'=>'return_front','class' => 'col-xs-10 col-sm-5', "data-provide"=>"markdown")) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                {{ Form::text('facility[1]',  Input::old('facility[1]'), array('class' => 'col-xs-10 col-sm-5')) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                {{ Form::text('facility[2]',  Input::old('facility[2]'), array('class' => 'col-xs-10 col-sm-5')) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                {{ Form::text('facility[3]',  Input::old('facility[3]'), array('class' => 'col-xs-10 col-sm-5')) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                {{ Form::text('facility[4]',  Input::old('facility[4]'), array('class' => 'col-xs-10 col-sm-5')) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                {{ Form::text('facility[5]',  Input::old('facility[5]'), array('class' => 'col-xs-10 col-sm-5')) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9" id="products">
                                ...
                                @if(Input::old('product')!="")

                                    @php

                                        $cmpTotal = count(Input::old('product'));
                                    ...
                                    @foreach(Input::old('product') as $item)

                                        @if($counter==1)

                                            {{ Form::text('product[]',  Input::old('product')[$counter-1], array('class' => 'col-xs-10 col-sm-5')) }}
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="checkbox">
                                        ...
                                        <label>
                                            ...
                                            {{ Form::checkbox('recommended','Yes',null,["class"=>"ace"]) }}
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div class="checkbox">
                                        ...
                                        <label>
                                            ...
                                            {{ Form::checkbox('featured',"Yes",null,["class"=>"ace"]) }}
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <div class="checkbox">
                                            ...
                                            <label>
                                                ...
                                                {{ Form::checkbox('cancelable','Yes',null,["class"=>"ace"]) }}
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <div class="checkbox">
                                            ...
                                            <label>
                                                ...
                                                {{ Form::checkbox('editable',"Yes",null,["class"=>"ace"]) }}
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="col-sm-12 awards-pic">
                                        ...
                                        <div class="col-sm-6"><input type="checkbox" checked="" name="awards[]"

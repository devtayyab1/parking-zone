                        ...
                        <div class="form-group ">
                            <select class="chosen-select form-control" id="company"
                                ...
                                @foreach($companies as $company)
                                    <option @if( Input::get("cid") == $company["id"] ) {{ 'selected="selected"' }} @endif value="{{ $company["id"] }}">{{ $company["name"] }}</option>
                        ...
                        <div class="form-group ">
                            <select class="chosen-select form-control" id="year"
                                ...
                                @foreach($years as $year)
                                    <option @if ( Input::get('year') == $year ) {{ 'selected="selected"' }} @endif value="{{ $year }}">{{ $year}}</option>
                        ...
                        <div class="form-group ">
                            <select class="chosen-select form-control" id="month"
                                ...
                                @foreach($months as $month)
                                    <option @if( Input::get("month") == date('m', strtotime($month)) ) {{ 'selected="selected"' }} @endif value="{{ date("m", strtotime($month)) }}">{{ $month}}</option>

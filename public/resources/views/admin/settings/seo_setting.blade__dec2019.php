                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    @endif
                                    {{ Form::textarea('setting[site_twitter_title]', $site_twitter_title , array('class' => 'form-control',"id"=>"content")) }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    @endif
                                    {{ Form::textarea('setting[site_og_title]', $site_og_title , array('class' => 'form-control',"id"=>"content")) }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    @endif
                                    {{ Form::textarea('setting[site_og_url]', $site_og_title , array('class' => 'form-control',"id"=>"content")) }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    @endif
                                    {{ Form::textarea('setting[site_og_image]', $site_og_title , array('class' => 'form-control',"id"=>"content")) }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    @endif
                                    {{ Form::textarea('setting[site_og_type]', $site_og_title , array('class' => 'form-control',"id"=>"content")) }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    @endif
                                    {{ Form::textarea('setting[site_author]', $site_site_author , array('class' => 'form-control',"id"=>"content")) }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    @endif
                                    {{ Form::textarea('setting[site_schema]', $site_schema , array('class' => 'form-control',"id"=>"content")) }}

            ...
            <div class="col-xs-12">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        {{ Form::open(array('class'=>'form-horizontal','method'=>'post','route' => 'awards.store', 'files' => true)) }}
                        <div class="form-group">
                            {{ Form::label('aname', 'Award Name', array('class' => 'col-sm-3 control-label no-padding-right')) }}
                        ...
                        <div class="form-group">
                            {{ Form::label('award_image', 'Award Image', array('class' => 'col-sm-3 control-label no-padding-right')) }}

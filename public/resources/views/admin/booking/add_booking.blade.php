                                                ...
                                                <form id="quote">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-12">
                                                                {{ Form::text('dep_date',  Input::old('dep_date'), array('class' => 'col-xs-12 col-sm-12 date-picker',"data-date-format"=>"dd-mm-yyyy","id"=>"dep_date","required"=>"required")) }}
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-12">
                                                                {{ Form::text('return_date',  Input::old('return_date'), array("id"=>"return_date",'class' => 'col-xs-12 col-sm-12 date-picker',"required"=>"required")) }}
...
<div>@php 
echo "<pre>"; echo print_r($booking_detail); echo "</pre>";
@endphp</div>

                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <input email="true" class="form-control bf-inptfld disablecopypaste" placeholder="Email"
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <input class="form-control bf-inptfld disablecopypaste" type="text" placeholder="Confirm Email"
                                                        ...
                                                        <div class="col-lg-4">
                                                            ...
                                                            <input class="form-control bf-inptfld" type="number" placeholder="Mobile"
    ...
    margin: auto;" 
                                                    ...
                                                    <div class="paymentFrm" id="paymentFrm">
                                                        ...
                                                        <div id="card-element"></div>
                                                               ...
                                                               <center>  <h4 style="margin-top:10px;"><span class="badge badge-warning" style="background-color:#340a4d;" >Your Card Will Be Charged</span> <span class="badge badge-danger" style="background-color:#090;" > <strong>£<span
                                                            ...
                                                            <center> <button class="btn cnf_booking btn-lg btn-warning center-block"
                                                                    ...
                                                                    type="submit" id="bookingButton1">Confirm Booking
                        ...
                        <div class="row" style="margin-top: 4px;">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding: 0px">
                                ...
                                <h3 style="padding:13px 20px 13px !important" class="btn btn-lg btn-yellow col-sm-12 col-xs-12 col-md-12"
                                    ...
                                    <input type="hidden" id="src" value="{{ isset($data['src']) ? $data['src'] : 'ORG' }}">

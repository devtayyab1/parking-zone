                    ...
                    <div class="footer_col">
                        <div class="footer_content footer_about">
                            <div class="logo_container footer_logo">
                                <div class="logo"><a href="#"><img style="width: 175px;" src="{{url('theme/images/logo1.png')}}" alt=""></a></div>
                            </div>
                            <p class="footer_about_text">{{$site_settings_main["footer_catch_line"]}}</p>
                                <div class="row copy-right-main"> 
                                            <a href="//www.dmca.com/Protection/Status.aspx?ID=00d7fa62-cad9-46d5-a753-ca722bb5c731" title="DMCA.com Protection Status" class="dmca-badge"> <img src ="https://images.dmca.com/Badges/_dmca_premi_badge_5.png?ID=00d7fa62-cad9-46d5-a753-ca722bb5c731"  alt="DMCA.com Protection Status" /></a>  <script src="https://images.dmca.com/Badges/DMCABadgeHelper.min.js"> </script>
                                          
                                            <a href="https://www.dmca.com/compliance/www.parkingzone.co.uk" title="DMCA Compliance information for www.parkingzone.co.uk"><img width="80" style="    margin-left: 8px;" src="{{ secure_asset("public/assets/dmca.png") }}" /></a>
                ...
                <div class="col-lg-3 col-md-6 footer_column">
                    <div class="footer_col">
                        <div class="footer_title">Other Pages</div>
                            ...
                            <br>
                            <p class="footer_title" style="font-weight: 500; text-transform: none;">Email: <a href="mail:bookings@parkingzone.co.uk">bookings@parkingzone.co.uk</a></p> 
                            <p class="footer_title" style="font-weight: 500; text-transform: none;">Phone:  <a href="tel:+442045114174"> 020 4511 4171</a></p> 
...
<script src="{{url('theme/styles/bootstrap4/popper.js')}}" defer></script>
<script src="{{url('theme/styles/bootstrap4/bootstrap.min.js')}}" defer></script>
<script src="{{url('theme/plugins/OwlCarousel2-2.2.1/owl.carousel.js')}}" defer></script>
<script src="{{url('theme/plugins/easing/easing.js')}}" defer></script>
<script src="{{url('theme/js/custom.js')}}" defer></script>

    ...
    border-radius: 23px;     background-color: #fff;">
                                    ...
                                    <div class="top-bar">
                                        ...
                                        <div class="top-bar-right col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
                                            ...
                                            <h1 style="color: #000; font-weight: 600;">Booking Details</h1>
                                    ...
                                    <div class="confirm col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <h1 style="color: #000; font-weight: 600;">Booking Confirmation</h1>
                                    ...
                                    <div class="detail col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <div class="sub-detail"
                                            ...
                                            <h1 style="color: #000; font-weight: 600;">Arrival</h1>
                                    ...
                                    <div class="detail col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <div class="sub-detail"
                                            ...
                                            <h1 style="color: #000; font-weight: 600;">Departure</h1>
                                    ...
                                    <div class="detail col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        ...
                                        <div class="sub-detail"
                                            ...
                                            <h1 style="color: #000; font-weight: 600;">Terms &amp; Conditions</h1>
                    ...
                    <div class="col-md-3" style="background: #fff;    padding-top: 33px;">
                            ...
                            <div class="col-md-12 ">
                                ...
                                <ul style="padding: 0px;">
                                    ...
                                    <li class="text-success" id="pri">
                                        ...
                                        <button type="button" class="btn btn-yellow" id="RButton" style="background: #f99f03; width: 88%;"><i

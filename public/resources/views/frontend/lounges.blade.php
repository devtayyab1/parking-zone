                        ...
                        <div id="service-blocks">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                <div class="service-block"  >
                                    <img src="assets/images/early.jpg" class="img-circle" style="width:80px;height:80px" alt="logo">
                                    <h2 class="service-name">Arrive Early and Unwind</h2>
                                        <p>{!! $site_settings_main["services_page_lounges_sec1_grid1"];  !!}</p></div><!-- end service-block -->
                            </div><!-- end columns -->

                            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                <div class="service-block" >
                                   <img src="assets/images/family.png" class="img-circle" style="width:80px;height:80px" alt="logo">
                                    <h2 class="service-name">Treat the Family</h2>
                                    <p>{!! $site_settings_main["services_page_lounges_sec1_grid2"];  !!}</p></div><!-- end service-block -->
                            </div><!-- end columns -->
                    
                            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                <div class="service-block">
                                   <img src="assets/images/money.jpg" class="img-circle" style="width:80px;height:80px" alt="logo">
                                    <h2 class="service-name">Get More For Your Money</h2>
                                    <p>{!! $site_settings_main["services_page_lounges_sec1_grid3"];  !!}</p></div><!-- end service-block -->
                            </div><!-- end columns -->

                            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                                <div class="service-block"  >
                                   <img src="assets/images/red.jpg" class="img-circle" style="width:80px;height:80px" alt="logo">
                                    <h2 class="service-name">Refresh After A Red-eye</h2>
                                    <p>{!! $site_settings_main["services_page_lounges_sec1_grid4"];  !!}</p></div><!-- end service-block -->
                            </div><!-- end columns -->
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                   ...
                   <div class="row">
                        <div id="service-blocks">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
                                <div class="service-block1"  >
                                    <img src="assets/images/peace.png" class="img-circle" style="width:80px;height:80px" alt="logo">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
                                <div class="service-block1"  >
                                   <img src="assets/images/beer.jpg" class="img-circle" style="width:80px;height:80px" alt="logo">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
                                <div class="service-block1"  >
                                   <img src="assets/images/privacy.png" class="img-circle" style="width:80px;height:80px" alt="logo">
                      ...
                      <!-- end row -->
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
                                <div class="service-block1"  style="min-height: 291px !important;">
                                   <img src="assets/images/newspaper.jpg" class="img-circle" style="width:80px;height:80px" alt="logo">

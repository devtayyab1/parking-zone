...
@include('layouts.search_form_result_lounge')
<section id="section">
	<div class="container">
...
$( document ).ready(function() {
    ...
    ajdata['checkin_date'] = '{{ request()->checkin_date }}';
    ajdata['checkin_time'] = '{{ request()->checkin_time }}';

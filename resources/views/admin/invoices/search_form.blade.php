            ...
            <div class="row">
                ...
                @if($show==1)
                    ...
                    <div class="col-md-12 text-right section-right" style="margin-top: 10px">
                        ...
                        <a id="excel" class="btn btn-primary exxl" href="{{ route("invoicesDetailInvoice") }}?filter=departDate&search=&start_date={{ $start_date}}&end_date={{ $end_date}}&filter={{ $filter }}&companies=all&airport=all&status=all&admins=all&payment=all&refund_via=all&palenty_to=all"><i class="entypo-download"></i>Download Detail Invoice</a>

                        <a id="excel" class="btn btn-primary exxl" href="{{ route("invoiceSummery") }}?filter=departDate&search=&start_date={{ $start_date}}&end_date={{ $end_date}}&filter={{ $filter }}&companies=all&airport=all&status=all&admins=all&payment=all&refund_via=all&palenty_to=all"><i class="entypo-download"></i> Download Summary Invoice</a>
                        @endcan
                    </div>

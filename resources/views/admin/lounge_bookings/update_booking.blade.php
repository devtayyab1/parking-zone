...
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
  <form id="bookingDetails" method="post" action="{{route('update_lounge_booking')}}" >
    @csrf
        <input type="hidden" value="{{$booking_detail->id}}" name="id">
                <div class="row">
                    <div class="col-xs-12">
            ...
            <div class="step-content pos-rel">
				<div  class="col-lg-12 grid-box">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="field-1" class="col-sm-12 control-label">Checkin Date</label>
                            <div class="col-sm-12">
                                <input type="text" value="{{ \Carbon\Carbon::parse($booking_detail->check_in)->format('d-m-Y')}}" name="check_in" id="check_in"
                                       data-validate="required" data-message-required="Date is Required."
                                       class="form-control dpd1" placeholder="Checkin Date"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="field-1" class="col-sm-12 control-label">Checkin Time</label>
    
                            <div class="col-sm-12">
                                <input class="form-control" name="check_in_time" value="{{ \Carbon\Carbon::parse($booking_detail->check_in_time)->format('H:i')}}" id="check_in_time">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="field-1" class="col-sm-12 control-label">Adults</label>
                            <div class="col-sm-12">
                                <select required="" class="form-control" id="adults" name="adults">
							        <option @if($booking_detail->adults == '1') selected @endif value="1">1</option>
							        <option @if($booking_detail->adults == '2') selected @endif value="2">2</option>
							        <option @if($booking_detail->adults == '3') selected @endif value="3">3</option>
							        <option @if($booking_detail->adults == '4') selected @endif value="4">4</option>
							        <option @if($booking_detail->adults == '5') selected @endif value="5">5</option>
							        <option @if($booking_detail->adults == '6') selected @endif value="6">6</option>
						        </select>   
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="field-1" class="col-sm-12 control-label">Children</label>
                            <div class="col-sm-12">
                                <select required="" class="form-control" id="children" name="children">
                                    <option @if($booking_detail->adults == '1') selected @endif value="0">0</option>
							        <option @if($booking_detail->adults == '1') selected @endif value="1">1</option>
							        <option @if($booking_detail->adults == '2') selected @endif value="2">2</option>
							        <option @if($booking_detail->adults == '3') selected @endif value="3">3</option>
							        <option @if($booking_detail->adults == '4') selected @endif value="4">4</option>
                                ...
                                <div class="widget-body">
                                    <div class="widget-main">
                                        <table class="table">
                                            ...
                                            <tr>
                                                <th class="col-md-5">Checkin Date</th>
                                                <td id="deptdate_txt" class="col-md-5">
                                                    @if($booking_detail!="") {{ $booking_detail->check_in }} @endif

                                                </td>
                                            </tr>
                                            <tr>
                                                <th class="col-md-5">Lounge</th>
                                                <td id="company_txt" class="col-md-5">
                                                    {{ $booking_detail->lounge_name }}

...
@section('content')
    ...
    <div class="page-content">
     ...
     <div class="row">
                <div class="col-md-12">
                       <form action="{{ route('incomplete_Booking_lounge') }}" method="get" class="form-inline" style="margin-bottom: 10px;">
   ...
   <div class="form-group">
                ...
                <select name="filter" class="form-control input-sm" style="padding: 6px 2px; ">
                    ...
                    <option value="createdate" @if(Input::get('filter')=='createdate') {{ "selected='selected'" }} @endif >Booked Date</option>
                    <option value="check_in" @if(Input::get('filter')=='check_in') {{ "selected='selected'" }} @endif>Checkin Date</option>
            ...
            <div class="form-group" style="margin-top: 2.1%;">
                <input name="submit" type="submit" value="Search" class="btn btn-primary btn-sm">
                <a href='{{ route("incomplete_Booking_lounge") }}' class="btn btn-primary btn-sm">Reset</a>
            </div>
        </form>
                        ...
                        <table id="simple-table" class="table  table-bordered table-hover">
                            ...
                            @foreach($bookings as $booking)
                                <tr>
                                    ...
                                    <td class="">{{ date('d/m/Y h:i:s', strtotime($booking->check_in)) }}</td>

...
@php 
    ...
    $role_nam = App\users_roles::get_user_role(Auth::user()->id)->name;
        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                ...
                <div class="row">
                    ...
                    @if($role_nam == "SuperAdmin" || $role_nam == "Developers")
                    ...
                    <div class="row heading_title" ><h3>Home Page Headings</h3>
                        ...
                        @foreach($main_headings as $headings)

                            <div class="form-group">

                                {{ Form::label($headings["title"], $headings["title"], array('class' => 'col-sm-3 control-label no-padding-right')) }}
                                ...
                                <div class="col-sm-6">
                                    ...
                                    @if(array_key_exists($headings["fieldName"],$settings))

                                        @php $socialfield = $settings[$headings["fieldName"]]; @endphp

                                    @endif



                                    {{ Form::text('setting['.$headings["fieldName"].']',  $socialfield, array('class' => 'form-control')) }}
                                    ...
                                    @if ($errors->has('setting['.$headings["fieldName"].']'))
                                        ...
                                        <div class="alert alert-danger alert alert-danger "
                                            ...
                                            <strong>{{ $errors->first('setting['.$headings["fieldName"].']') }}</strong>

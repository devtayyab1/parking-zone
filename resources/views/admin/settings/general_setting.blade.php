            ...
            <div class="col-xs-12">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        {{ Form::open(array('class'=>'form-horizontal','method'=>'post','route' => ['settings.updateModuleSettings'])) }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    @if(array_key_exists("type",$social))
                                        {{ Form::select('setting['.$social["fieldName"].']',  $social["data"],$socialfield, array('class' => 'form-control')) }}

                ...
                <div class="row">
                    ...
                    @endif
                        ...
                        <div class="infobox infobox-green">
                            ...
                            <div class="infobox-data">
                                <span class="infobox-data-number">{{$todayAph}}</span>
                                <div class="infobox-content">APH Orders</div>
                            </div>
                        ...
                        <div class="infobox infobox-green">
                            ...
                            <div class="infobox-data">
                                <span class="infobox-data-number">{{$todayHe}}</span>
                                <div class="infobox-content">Holiday Orders</div>
                            </div>
                        ...
                        <div class="infobox infobox-green">
                            ...
                            <div class="infobox-data">
                                <span class="infobox-data-number">{{$todayGlb}}</span>
                                <div class="infobox-content">Global Orders</div>
                            </div>
                        ...
                        <div class="infobox infobox-green">
                            ...
                            <div class="infobox-data">
                                <span class="infobox-data-number">{{$todayOpi}}</span>
                                <div class="infobox-content">Opitech Orders</div>
                            </div>

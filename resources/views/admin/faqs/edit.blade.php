...
@section('content')
    ...
    <div class="page-content">
       ...
       <option value="{{$airport->id}}" @if($aid == $airport->id ) {{ "selected='selected'" }}@endif>{{$airport->name}}</option>                
       @endforeach                                   
       </select>
  ...
  <div class="form-group" id="agentID">
       ...
       <option value="{{$key}}" @if($agid == $key ) {{ "selected='selected'" }}@endif>{{$agentsList}}</option>                
       @endforeach                                   
       </select>

                    ...
                    <div class="col-xs-12">
                        ...
                        @if($role->roles->role->name=='SuperAdmin')
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4" id="agents_list">
                                    @foreach($agents as $key=>$agent)
                                        @php $checked=false; @endphp
                                        @if(in_array($key,$user_agents))
                                            @php $checked=true; @endphp
                                        @endif
                                        {{Form::checkbox('agents[]', $key, $checked)}} {{ ucfirst($agent) }}
                                        <br/>
                                    @endforeach
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4" id="pages_list" style="height: 250px;overflow: scroll;">
                                    <div class="checkbox"> 
                                        <label>
                                            <input type="checkbox" name="pages[]" id="select-alll" value="all">All
                                        </label>
                                            <br>                                                                                
                                    </div>
                                    @foreach($pages as $key=>$page)
                                        ...
                                        @if(in_array($page,$users_hide_pages_list))
                                            @php $checked=true; @endphp
                                        @endif
                                        {{Form::checkbox('pages[]', $page, $checked, ['class' => 'checks'])}} {{ ucfirst($page) }}
                                        <br/>
                                    @endforeach
                                </div>
                            </div>

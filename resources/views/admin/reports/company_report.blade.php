        ...
        <form action="{{ route("company_report") }}" method="get" class="form-inline" style="margin-bottom: 10px;">
            ...
            <div class="form-group" style="width: 170px;">
                ...
                <input type="text" value="{{ Input::get('search') }}" name="search" class="form-control input-sm" id="field-1" value=""
                       ...
                       placeholder="Search By Keyword" style="form-control input-sm">
            ...
            <div class="form-group">
                ...
                <select id="my_status" name="status" class="form-control input-sm" style="form-control input-sm" required="">
            ...
            <div class="form-group">
                ...
                <select name="filter" class="form-control input-sm" style="form-control input-sm">
                            ...
                            @if($show==1)
                                ...
                                <div class="row">
                                    ...
                                    @can('user_auth', ["Downloads"])
										...
										<a id="excel" class="btn btn-primary btn-sm exxl" href='{{ route("company_report_excel") }}?filter={{ Input::get("filter") }}&search=&start_date={{ Input::get("start_date") }}&end_date={{ Input::get("end_date") }}&companies={{ Input::get("companies") }}&airport={{ Input::get("airport") }}&status={{ Input::get("status") }}&admins={{ Input::get("admins") }}&payment={{ Input::get("payment") }}&refund_via={{ Input::get("refund_via") }}&palenty_to={{ Input::get("palenty_to") }}'><i class="entypo-download"></i>Download Excel</a>
                                    @endcan
									</div>
                                </div>
                            @endif

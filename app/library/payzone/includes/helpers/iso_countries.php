...
/**
 * [ISOCountries  list mapping for name to code conversion]
 */
class ISOCountries
{
	/**
	 * [getISOCountryList ISOCountries list mapping for name to code conversion]
	 * @method getISOCountryList
	 * @return [Object]            [ISOCountry list object with countries added]
	 */
	public static function getISOCountryList()
	{
		$iclISOCountryList = new \Payzone\Gateway\Common\ISOCountryList();

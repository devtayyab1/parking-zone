...
<div class="col-xs-12 col-sm-12 col-md-3 col-md-push-9 col-lg-push-9 col-lg-3 side-bar">
                        ...
                        <div class="row" style="margin-top: 4px;margin-left: -21px;">

                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding: 0px">

                                <h3 style="padding:13px 20px 0px !important; margin-bottom: 15px;" class="btn btn-lg btn-yellow col-sm-12 col-xs-12 col-md-12"><p><span><i
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="col-lg-2 setgenderwidth">
                                                            ...
                                                            <select required class="bf-slctfld bookingselect_height"
                                                        ...
                                                        <div class="col-lg-12" id="full_address12">
                                                            ...
                                                            <div class="form-inline ">
                                                                ...
                                                                <div id="postcode_lookup">
                                                                    ...
                                                                    {{--style="width: 70%;margin-right: 27px;"--}}

                                                                    {{--type="text" id="opc_input"--}}

                                                                    {{--value=""--}}

                                                                    {{--class="my-class form-control bf-inptfld"--}}

                                                                    {{--autocomplete="off">--}}

                                                                    {{--<button id="find_address" style="    height: 44px;" type="button"--}}
                                            ...
                                            <div class="">
                                                    ...
                                                    <div class="paymentFrm" id="paymentFrm">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <div class="card_chrge">
                                                                ...
                                                                <h1>Your Card Will Be Charged <strong>£<span

                                                                                id="ccPrice">78.98</span></strong></h1>
                                                            ...
                                                            <button class="btn cnf_booking btn-lg btn-yellow center-block"
                                                ...
                                                @if($settings["payment_type"]=='payzone')
                                                    ...
                                                    <form id="payzone_form">
                                                        ...
                                                        <div id="error_personal_detail" style="color:red"></div>



                                                        <button class="btn btn-lg btn-yellow center-block cnf_booking"



                                                                type="button" onclick="payzone_submit()">Confirm Booking

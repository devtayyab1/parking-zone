    ...
    <div class="page-content">
        ...
        <form action="{{ route("invoice_commission_report") }}" method="get" class="form-inline" style="margin-bottom: 10px;">
            ...
            <div class="form-group">
                ...
                <a href="{{ route("invoice_commission_report") }}" class="btn btn-primary">Reset</a>
            </div>
        </form>
                        ...
                        @endif
                            @if($show==1)
                                <div class="col-md-12 text-right section-right" style="margin-top: 10px">
                                    ...
                                    <a id="excel" class="btn btn-primary exxl" href="{{ route("invoice_operation_report_excel") }}?filter={{ Input::get("filter") }}&search=&start_date={{ Input::get("start_date") }}&end_date={{ Input::get("end_date") }}&companies={{ Input::get("companies") }}&airport={{ Input::get("airport") }}&status={{ Input::old("status") }}&admins={{ Input::get("admins") }}&payment={{ Input::get("payment") }}&refund_via={{ Input::get("refund_via") }}&palenty_to={{ Input::get("palenty_to") }}"><i class="entypo-download"></i>Download Excel</a>
                                </div>
                            @endif

...
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="page-header">
            <h1>
            Services Pages Content Settings
                <small>
...
<div class="row heading_title" ><h3>Airport Parking</h3>
                        ...
                        @foreach($parking_settings as $social)
...
<div class="row heading_title" ><h3>Airport Lounges</h3>

</div>



                        @foreach($lounges_settings as $social)
                            <div class="form-group">
                                {{ Form::label($social["title"], $social["title"], array('class' => 'col-sm-3 control-label no-padding-right')) }}
...
<div class="row heading_title" ><h3>Airport Transfer</h3>
                        ...
                        @foreach($transfer_settings as $social)
                            <div class="form-group">
                                {{ Form::label($social["title"], $social["title"], array('class' => 'col-sm-3 control-label no-padding-right')) }}

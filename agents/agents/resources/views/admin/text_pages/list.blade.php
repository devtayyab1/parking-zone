...
<th>Page Title</th>
  ...
  @foreach($pages as $page)
                                                    <tr>
                                                       <td class="hidden-480">{{ $page->page_title }}</td>
                                    <td class="hidden-480">{{ $page->slug }}</td>
                                    <td class="hidden-480">{{ $page->type }}</td>
                                    <td class="hidden-480">{{ $page->meta_keyword }}</td>
                                    <td class="hidden-480">@if($page->status=="Yes") {{ "Active"  }} @else {{ "Inactive" }} @endif</td>

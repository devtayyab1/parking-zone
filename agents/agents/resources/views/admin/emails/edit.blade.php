            ...
            <div class="col-xs-12">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        {{ Form::open(array('class'=>'form-horizontal','method'=>'PUT','route' => ['emails.update',$email->id])) }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    {{ Form::text('title',  $email->title , array('class' => 'form-control')) }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    {{ Form::text('subject',  $email->subject , array('class' => 'form-control')) }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    {{ Form::textarea('description', $email->description, array('id'=>'content','class' => 'form-control', "data-provide"=>"markdown")) }}

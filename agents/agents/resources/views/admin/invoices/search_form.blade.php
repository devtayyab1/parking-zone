            ...
            <div class="row">
                <div class="col-md-12" style="padding: 10px; border-bottom: 1px solid  #ccc;">
                    <form method="post" action="{{ route('searchFormSubmit') }}">
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                <input class="form-control date-picker" value="{{ $start_date}}" autocomplete="off" id="start_date" name="start_date" type="text"
                        ...
                        <div class="col-md-3">
                            <div class="input-group">
                                <input class="form-control date-picker" value="{{ $end_date}}"  autocomplete="off" id="end_date" name="end_date" type="text"
                                       data-date-format="dd-mm-yyyy"/>
                                <span class="input-group-addon">
																		<i class="fa fa-calendar bigger-110"></i>
																	</span>
                ...
                @if($show==1)
                    <div class="col-md-12 text-right section-right" style="margin-top: 10px">
                        ...
                        <a id="excel" class="btn btn-primary exxl" href="{{ route("invoicesDetailInvoice") }}?filter=departDate&search=&start_date={{ $start_date}}&end_date={{ $end_date}}&companies=all&airport=all&status=all&admins=all&payment=all&refund_via=all&palenty_to=all"><i class="entypo-download"></i>Download Summary Invoice</a>
                        <a id="excel" class="btn btn-primary exxl" href="{{ route("invoiceSummery") }}?filter=departDate&search=&start_date={{ $start_date}}&end_date={{ $end_date}}&companies=all&airport=all&status=all&admins=all&payment=all&refund_via=all&palenty_to=all"><i class="entypo-download"></i>Download Detail Invoice</a>
                    </div>
                @endif

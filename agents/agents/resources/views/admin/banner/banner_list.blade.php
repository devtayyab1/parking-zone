                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="form-group">
                            {{ Form::label('Banner 1', 'Banner 1', array('rows'=>'10',"cols"=>"50",'class' => 'col-sm-3 control-label no-padding-right')) }}
                        ...
                        <div class="form-group">
                            {{ Form::label('Banner 2', 'Banner 2', array('rows'=>'10',"cols"=>"50",'class' => 'col-sm-3 control-label no-padding-right')) }}
                        ...
                        <div class="form-group">
                            {{ Form::label('Banner 3', 'Banner 3', array('rows'=>'10',"cols"=>"50",'class' => 'col-sm-3 control-label no-padding-right')) }}

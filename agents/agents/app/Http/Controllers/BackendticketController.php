...
//					ORDER BY FIELD(t.urgency,'High','Medium','Low') , t.id DESC");
        ...
        $tickets = $tickets->join('users as u', 'tickets.assign_to', '=', 'u.id');
...
//        }
    ...
    public function myticketview($id)
    {
        ...
        ticket_chat::where("ticket_id", $ticket->id)->update(["adminunread" => "No"]);
    ...
    public function getNewMessages()
    {
        ...
        $tickets = $tickets->where("tickets.assign_to", "=", $id);
        $tickets = $tickets->where("c.adminunread", "=", "Yes");

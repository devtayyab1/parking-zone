...
class SMSController extends Controller
{
    ...
    public  static  function send_sms($number, $ref){
        ...
        $getString .="msg=".urlencode("Thank you for choosing Flyparkplus. Your booking with Ref# ".$ref." is confirmed, for arrival & departure procedure please check your email.")."&";

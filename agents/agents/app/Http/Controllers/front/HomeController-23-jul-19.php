...
//        }
        ...
        return view("frontend.search_result", ["airports" => $airports, "companies" => $companies, "companies_special_features" => $companies_special_features, "request" => $request, "no_of_days" => $no_of_days, "promo" => $promo,"bookingfor"=>$bookingfor,"airport_detail"=>$airport_detail]);


//        $airports = airport::all()->where("id", $airport_id)->toArray();
//
...
//		RequestCode="11">
//		<Agent>
//		<ABTANumber>FPP</ABTANumber>
//		<Password>JJSTB</Password>
//		<Initials>FLYPARKPLUS</Initials>
//		</Agent>
//		<Itinerary>

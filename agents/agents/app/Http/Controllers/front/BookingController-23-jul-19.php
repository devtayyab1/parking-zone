...
class BookingController extends Controller
{
    ...
    public $_setting = [];
    public $stripeKey = "sk_test_30ruNFqkC3scsry4sLciMFQn";
    public $currency = "GBP";
...
//        $data["payment_status"] = $request->input("subscribe");
        ...
        $template_data["airport"] = $request->input("airport");
        ...
        $template_data["r_flight_no"] = $request->input("total_days");
        ...
        $template_data["price"] = $request->input("total_days");
